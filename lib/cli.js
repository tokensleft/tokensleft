...
export async function runCli(argv = process.argv.slice(2)) {
  ...
  const { runDashboard, terminalProfile } = await import('./tui.js');
  runDashboard({ screenTitle: heading, title: 'TokensLeft', terminal: terminalProfile(dashboardEnv), providers });
}

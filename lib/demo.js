...
import { buildKimiItems, KIMI_LOCAL_OPTS } from '../providers/kimi.js';
...
import { createSingleAccountProvider, multiAccountHeaderStatus, usageAlertItems } from './provider.js';
...
const CLAUDE_LOCAL_MODELS = [
  {
    ...
    week: { input: 8_400_000, cacheRead: 280_000_000, cacheWrite: 4_200_000, output: 1_900_000, cost: 145.55, messages: 980 },
    month: { input: 26_000_000, cacheRead: 890_000_000, cacheWrite: 12_000_000, output: 6_100_000, cost: 475.89, messages: 3100 },
    all: { input: 26_000_000, cacheRead: 890_000_000, cacheWrite: 12_000_000, output: 6_100_000, cost: 475.89, messages: 3100 },
  },
  {
    model: 'claude-fable-5',
    today: { output: 0, cost: 0 },
    week: { input: 1_800_000, cacheRead: 64_000_000, cacheWrite: 900_000, output: 261_400, cost: 106.59, messages: 420 },
    month: { input: 6_100_000, cacheRead: 220_000_000, cacheWrite: 3_000_000, output: 926_100, cost: 346.97, messages: 1420 },
    all: { input: 7_500_000, cacheRead: 270_000_000, cacheWrite: 3_600_000, output: 1_100_000, cost: 391.93, messages: 1710 },
  },
  {
    model: 'claude-opus-4-8',
    today: { input: 1_400_000, cacheRead: 31_000_000, cacheWrite: 700_000, output: 221_800, cost: 51.09, messages: 130 },
    week: { input: 2_200_000, cacheRead: 49_000_000, cacheWrite: 1_100_000, output: 329_900, cost: 72.13, messages: 240 },
    month: { input: 6_400_000, cacheRead: 142_000_000, cacheWrite: 3_200_000, output: 961_100, cost: 168.32, messages: 690 },
    all: { input: 8_000_000, cacheRead: 175_000_000, cacheWrite: 4_000_000, output: 1_200_000, cost: 202.30, messages: 860 },
  },
  {
    model: 'claude-haiku-4-5-20251001',
    today: { output: 0, cost: 0 },
    week: { output: 0, cost: 0 },
    month: { input: 15_000, cacheRead: 300_000, cacheWrite: 8000, output: 2600, cost: 0.14, messages: 18 },
    all: { input: 70_000, cacheRead: 1_800_000, cacheWrite: 40_000, output: 14_000, cost: 0.54, messages: 95 },
  },
];
...
const CODEX_LOCAL_MODELS = [
  {
    model: 'gpt-5.5',
    today: { output: 0, cost: 0 },
    week: { input: 2_400_000, cacheRead: 38_000_000, output: 317_400, cost: 51.27, messages: 650 },
    month: { input: 4_100_000, cacheRead: 64_000_000, output: 537_500, cost: 94.09, messages: 1100 },
    all: { input: 5_900_000, cacheRead: 91_000_000, output: 771_400, cost: 142.73, messages: 1680 },
  },
  {
    model: 'gpt-5.6-sol',
    today: { input: 900_000, cacheRead: 12_000_000, output: 163_000, cost: 28.45, messages: 480 },
    week: { input: 1_800_000, cacheRead: 26_000_000, output: 301_900, cost: 62.13, messages: 920 },
    month: { input: 1_800_000, cacheRead: 26_000_000, output: 301_900, cost: 62.13, messages: 920 },
    all: { input: 1_800_000, cacheRead: 26_000_000, output: 301_900, cost: 62.13, messages: 920 },
  },
  {
    model: 'codex-auto-review',
    today: { output: 0, cost: null },
    week: { input: 2100, output: 345, cost: null, messages: 3 },
    month: { input: 2100, output: 345, cost: null, messages: 3 },
    all: { input: 2100, output: 345, cost: null, messages: 3 },
  },
];
...
const GEMINI_LOCAL_MODELS = [
  {
    ...
    all: { input: 45_000, cacheRead: 180_000, output: 5200, cost: 0.13, messages: 18 },
  },
];
...
const KIMI_LOCAL_MODELS = [
  {
    model: 'kimi-code/k3',
    today: { input: 220_000, cacheRead: 4_800_000, cacheWrite: 310_000, output: 68_000, cost: 4.2825, messages: 55 },
    week: { input: 1_400_000, cacheRead: 31_000_000, cacheWrite: 1_800_000, output: 430_000, cost: 26.7, messages: 340 },
    month: { input: 1_400_000, cacheRead: 31_000_000, cacheWrite: 1_800_000, output: 430_000, cost: 26.7, messages: 340 },
    all: { input: 1_400_000, cacheRead: 31_000_000, cacheWrite: 1_800_000, output: 430_000, cost: 26.7, messages: 340 },
  },
  {
    model: 'kimi-code/kimi-for-coding',
    today: { output: 0, cost: null },
    week: { input: 90_000, cacheRead: 1_600_000, cacheWrite: 120_000, output: 24_000, cost: null, messages: 21 },
    month: { input: 150_000, cacheRead: 2_900_000, cacheWrite: 210_000, output: 42_000, cost: null, messages: 38 },
    all: { input: 150_000, cacheRead: 2_900_000, cacheWrite: 210_000, output: 42_000, cost: null, messages: 38 },
  },
];
...
function makeKimiDemo(context) {
  ...
  return makeSingleAccountDemo({
    ...
    localModels: KIMI_LOCAL_MODELS,
    localFiles: 15,
    localOpts: KIMI_LOCAL_OPTS,
  }, context);
}

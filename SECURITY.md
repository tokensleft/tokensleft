...
TokensLeft reads credentials owned by supported local CLIs and sends quota requests directly to their providers. It has no telemetry or intermediary service.
